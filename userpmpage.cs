...
namespace BlueBrick
{
    public class UserPMPage
    {
        ...
        private IPropertyManagerPageTab ppagetab1;

        private IPropertyManagerPageTab ppagetab2;

        //Local Objects
        public IPropertyManagerPage2 swPropertyPage;
        ...
        public UserPMPage(SwAddin addin)
        {
            ...
            else
            {
                ...
                MessageBox.Show("SwAddin not set.");
            }
        }
        ...
        {
            var errors = -1;
            var options = (int)swPropertyManagerPageOptions_e.swPropertyManagerOptions_OkayButton |
                          (int)swPropertyManagerPageOptions_e.swPropertyManagerOptions_CancelButton;

            handler = new PMPHandler(userAddin, this);
            swPropertyPage = iSwApp.ICreatePropertyManagerPage("Sample PMP", options, handler, ref errors);
        ...
        protected void AddControls()
        {
            ...
            textbox1 = (IPropertyManagerPageTextbox)group1.AddControl(textbox1ID, controlType, "Type Here", align,
                options, "This is an example text box");
            ...
            checkbox1 = (IPropertyManagerPageCheckbox)group1.AddControl(checkbox1ID, controlType, "Sample Checkbox",
                align, options, "This is a sample checkbox");
            ...
            option1 = (IPropertyManagerPageOption)group1.AddControl(option1ID, controlType, "Option1", align, options,
                "Radio Buttons");
            ...
            option2 = (IPropertyManagerPageOption)group1.AddControl(option2ID, controlType, "Option2", align, options,
                "Radio Buttons");
            ...
            option3 = (IPropertyManagerPageOption)group1.AddControl(option3ID, controlType, "Option3", align, options,
                "Radio Buttons");
            ...
            list1 = (IPropertyManagerPageListbox)group1.AddControl(list1ID, controlType, "Sample Listbox", align,
            ...
            selection1 = (IPropertyManagerPageSelectionbox)group2.AddControl(selection1ID, controlType,
                "Sample Selection", align, options, "Displays features selected in main view");
            if (selection1 != null)
            {
            ...
            num1 = (IPropertyManagerPageNumberbox)group2.AddControl(num1ID, controlType, "Sample Number box", align,
                options, "Allows for numerical input");
            if (num1 != null)
            {
                num1.Value = 50.0;
            ...
            combo1 = (IPropertyManagerPageCombobox)group2.AddControl(combo1ID, controlType, "Sample Combobox", align,
                options, "Combo list");
            if (combo1 != null)
            {
                string[] items = { "One Fish", "Two Fish", "Red Fish", "Blue Fish" };
            ...
            button1 = (IPropertyManagerPageButton)group2.AddControl2(buttonID1, controlType, "Hide", align, options,
            ...
            textbox2 = (IPropertyManagerPageTextbox)group2.AddControl2(textbox2ID, controlType, "Sample Text box",
                align,
                options, "Sample Text box text");
            ...
            button2 = (IPropertyManagerPageButton)group2.AddControl2(buttonID2, controlType, "Disable", align, options,
                "Disable the control");
            ...
            textbox3 = (IPropertyManagerPageTextbox)group2.AddControl2(textbox3ID, controlType,
                "Another sample Text box", align, options, "Second Sample Text box text");
        }
